...
def visualize_data(data):
    ...
    fig, axes = plt.subplots(len(data), 2, figsize=(8,8))
...
def check_accuracy(batch, method, reg, costmatrix = None):
    """
    Checks the accuracy of a `method`-Sinkhorn solver compared to a batch of data.
...
def plot_conf(
    ...
    """
    Plots data containing average values alongside their confidence intervals.
